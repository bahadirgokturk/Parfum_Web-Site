...
const messages = {
  ...
  en: {
    ...
    collection: { kicker: "The first edit", title: "Pieces for your daily ritual", note: "Product names and details are prototype content awaiting brand approval.", add: "Add to demo bag", details: "View details" },
  ...
  fr: {
    ...
    collection: { kicker: "Première sélection", title: "Des pièces pour votre rituel", note: "Les noms et détails des produits sont provisoires, en attente de validation.", add: "Ajouter au sac démo", details: "Voir les détails" },
